...
@RestController
@RequestMapping("/api/foreign-exchange-kafka")
public class ForeignExchangeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ForeignExchangeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ForeignExchangeKafkaResource(KafkaProperties kafkaProperties) {
